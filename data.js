...
const CATEGORY_META = {
  flagship: { label: "Flagship Paper",    color: "var(--c-flagship)", emoji: "🏔️" },
  methods:  { label: "Methods Papers",    color: "var(--c-methods)",  emoji: "📡" },
  network:  { label: "Network & ML",      color: "var(--c-network)",  emoji: "🕸️" },
  package:  { label: "txomics Package",   color: "var(--c-package)",  emoji: "📦" },
  cursor:   { label: "Cursor Phases",     color: "var(--c-cursor)",   emoji: "🤖" },
  learning: { label: "Learning Plan",     color: "var(--c-learning)", emoji: "📚" },
  career:   { label: "Career Path",       color: "var(--c-career)",   emoji: "🚀" },
};
...
const QUEST_DATA = {
  ...
  flagship: [
    {
      ...
      emoji: "🔬",
      desc: "Post-hoc FDR threshold sweep from dots.hdf5. Establish optimal decode yield. Gene-stratified efficiency plot.",
      category: "flagship", priority: "P0",
      xp: 30,
...

    {
      ...
      emoji: "🔵",
      desc: "Cell segmentation validation, CPS proxy scoring, DAPI ghost cell detection.",
      category: "flagship", priority: "P1",
      xp: 35,
      ...
      steps: [
        ...
        { id: "f-seg-3", title: "CPS proxy scoring (6 modules)", type: "code",
          ...
          xp: 12, cognitive_type: "deep", compute_lead_hrs: 12 },
          estimated_blocks: 2,
...

    {
      ...
      emoji: "🧩",
      desc: "CONCORD-based integration. Cell-type annotation. Efficiency confound removal.",
      category: "flagship", priority: "P1",
      xp: 40,
      ...
      steps: [
        { id: "f-ct-1", title: "CONCORD integration (cross-sample)", type: "code",
          ...
          xp: 12, cognitive_type: "deep", compute_lead_hrs: 24 },
          estimated_blocks: 2,
        { id: "f-ct-2", title: "Cell type clustering and annotation", type: "code",
          ...
          xp: 10, cognitive_type: "deep", compute_lead_hrs: 8 },
          estimated_blocks: 2,
        { id: "f-ct-3", title: "Subclustering per major cell type", type: "code",
          ...
          xp: 15, cognitive_type: "deep", compute_lead_hrs: 8 },
          estimated_blocks: 2,
...

    {
      ...
      emoji: "🗺️",
      desc: "BANKSY spatial clustering. Disease-emergent spatial domains (DESDs). Laminar architecture.",
      category: "flagship", priority: "P2",
      xp: 35,
      ...
      steps: [
        { id: "f-sd-1", title: "BANKSY spatial clustering", type: "code",
          ...
          xp: 12, cognitive_type: "deep", compute_lead_hrs: 16 },
          estimated_blocks: 2,
    ...
    {
      id: "f-deg",
      title: "Extended DEG Framework",
      emoji: "📊",
      desc: "5-level extended differential expression: gene → pathway coherence → spatial coherence → cell-type decomposition → cross-region replication.",
      category: "flagship", priority: "P3",
      xp: 45,
      ...
      steps: [
        { id: "f-deg-1", title: "Level 1: Pseudo-bulk DE (gene level)", type: "code",
          ...
          xp: 10, cognitive_type: "deep", compute_lead_hrs: 12 },
          estimated_blocks: 2,
        { id: "f-deg-2", title: "Level 2: Pathway coherence scoring", type: "code",
          ...
          xp: 10, cognitive_type: "deep", compute_lead_hrs: 6 },
          estimated_blocks: 2,
  ...
  methods: [
    {
      ...
      steps: [
        ...
        { id: "m-eef2-5", title: "smFISH wet lab validation", type: "wetlab",
          ...
          xp: 10, cognitive_type: "lab", compute_lead_hrs: 72 },
          estimated_blocks: 2,
      ],
  ...
  network: [
    ...
    },
    {
      ...
      steps: [
        { id: "n-pr-1", title: "PageRank on spatial gene-gene network", type: "code", desc: "Directed spatial co-expression network. PageRank: p_i = (1-d)/N + d * sum_j(p_j / C(j)) where C(j) = out-degree of j, d = 0.85 damping. High PageRank genes = master regulators.", checklist: ["Directed network built","PageRank converged (tolerance < 1e-6)","Top 20 PageRank genes identified","Cross-reference with known master regulators (STAT3, NFKB1, TP53 in probeset)"], xp: 20, cognitive_type: "deep" },
        estimated_blocks: 6,
        { id: "n-pr-2", title: "Influence maximization on subgraph", type: "code", desc: "Greedy algorithm: select seed set S to maximize activated nodes under independent cascade model. This identifies which genes, if targeted therapeutically, would most disrupt the disease network.", checklist: ["Independent cascade model implemented","Greedy seed selection (k=5 seeds)","Seed set interpreted biologically","Disease vs. CN network: do seed sets differ?"], xp: 20, cognitive_type: "deep" },
        estimated_blocks: 6,
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "n-tgn-1", title: "Prerequisite: GNN fundamentals", type: "learning", desc: "Before starting: complete learning plan GNN paper (Hamilton textbook + GNN papers). Target: build a simple GCN on CONCORD embedding as warm-up. Only advance when GCN runs correctly.", checklist: ["Hamilton GNN textbook Chapters 1-5 read","Simple GCN implemented on CONCORD embedding","GCN node classification AUC > 0.8 on held-out cells"], xp: 15, cognitive_type: "medium" },
        estimated_blocks: 3,
        { id: "n-tgn-2", title: "Braak stage as temporal graph", type: "code", desc: "Model each Braak stage as a time snapshot. TGN: node features = cell states; edges = spatial neighbors; temporal signal = Braak progression.", checklist: ["TGN architecture implemented (PyTorch Geometric)","Braak stage encoding as temporal signal","Prediction: TGN predicts Braak stage from spatial cell state"], xp: 35, cognitive_type: "deep" },
        estimated_blocks: 6,
      ],
  ...
  package: [
    ...
    },
    {
      ...
      steps: [
        { id: "pkg-sp-1", title: "BANKSY wrapper", type: "code", desc: "txomics.spatial.banksy(adata, lambda_param, resolution) runs BANKSY and returns adata with domain labels in adata.obs['spatial_domain']. Lambda parameter documented.", checklist: ["BANKSY installed as dependency","Function runs on real data","Lambda parameter with recommended values documented","Example in docs"], xp: 10, cognitive_type: "deep" },
        estimated_blocks: 4,
        { id: "pkg-sp-2", title: "Neighborhood composition", type: "code", desc: "txomics.spatial.neighborhood_composition(adata, radius, celltype_key) returns N_cells × N_celltypes composition matrix.", checklist: ["Radius parameter in µm (not pixels)","Handles edge cells correctly","Performance: < 60s for 50,000 cells"], xp: 8, cognitive_type: "deep" },
        estimated_blocks: 3,
    ...
    },
    {
      ...
      steps: [
        { id: "pkg-co-1", title: "CONCORD integration wrapper", type: "code", desc: "txomics.integration.run_concord(adata, batch_key, latent_dim) wraps CONCORD. Returns adata with X_concord in obsm. Efficiency batch handling documented.", checklist: ["Function runs on real data","LISI score computation included","Efficiency batch variable documented in tutorial"], xp: 10, cognitive_type: "deep" },
        estimated_blocks: 4,
        { id: "pkg-co-2", title: "SAE implementation", type: "code", desc: "txomics.interpretability.SparseAutoencoder(n_latent, n_features, lambda_l1). PyTorch implementation. Feature stability test included.", checklist: ["PyTorch dependency documented","Training loop with loss tracking","Feature interpretation helper: top_cells_per_feature()"], xp: 10, cognitive_type: "deep" },
        estimated_blocks: 4,
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "pkg-n-1", title: "Spatial graph builder", type: "code", desc: "txomics.network.build_spatial_graph(adata, method='knn', k=10) returns NetworkX graph or AnnData.obsp sparse matrix.", checklist: ["kNN and Delaunay options","Distance in µm","Symmetric adjacency matrix stored in obsp"], xp: 7, cognitive_type: "deep" },
        estimated_blocks: 3,
        { id: "pkg-n-2", title: "Assortativity + SIR", type: "code", desc: "txomics.network.assortativity(graph, node_attr) returns r. txomics.network.sir_model(adata, ...) returns R0, beta, gamma per sample.", checklist: ["Assortativity matches NetworkX reference","SIR returns R0 with CI","Both have unit tests"], xp: 8, cognitive_type: "deep" },
        estimated_blocks: 3,
        { id: "pkg-n-3", title: "Custom LR kernel", type: "code", desc: "txomics.network.lr_kernel(adata, lr_pairs, lambda_um=50) returns interaction score matrix.", checklist: ["lambda parameter in µm","LR pairs from CellChatDB loadable","Performance: < 60s for 50k cells × 200 LR pairs"], xp: 5, cognitive_type: "deep" },
        estimated_blocks: 2,
      ],
  ...
  cursor: [
    {
      id: "c-p0", title: "P0: Environment & Decoding QC", emoji: "🔧", category: "cursor", priority: "P0", xp: 25, reward: "🔧 Both repos initialized. FigureStyle class working. First QC figures made.",
      desc: "Repository setup (ad_seqfish_analysis + txomics), Python environment, dots.hdf5 reader, FDR sweep, decoding QC figures.",
      steps: [
        { id: "c-p0-1", title: "Cursor packet: P0_scaffold_and_infrastructure.md", type: "code", desc: "Follow P0 packet in Cursor. Key outputs: both repos initialized, conda/venv configured, FigureStyle class skeleton, RunContext class, AnnData schema defined.", checklist: ["Both repos on GitHub","conda env file committed","FigureStyle.apply() works","AnnData schema documented in README"], xp: 15, cognitive_type: "deep" },
        estimated_blocks: 6,
        { id: "c-p0-2", title: "Verify: dots.hdf5 loads + FDR sweep runs", type: "code", desc: "Run txomics.io.read_dots_hdf5() on actual data. Run txomics.qc.fdr_sweep(). Confirm outputs match known values (15.6% yield at FDR 0.05).", checklist: ["dots.hdf5 reads without error","FDR sweep produces expected decode yield","FDR sweep figure looks correct — matches expectations from existing analysis"], xp: 10, cognitive_type: "deep" },
        estimated_blocks: 4,
      ],
    ...
    {
      id: "c-p2", title: "P2: Efficiency & Normalization", emoji: "⚡", category: "cursor", priority: "P2", xp: 25, reward: "⚡ Efficiency confound characterized. Normalization pipeline locked.",
    ...
    {
      id: "c-p3", title: "P3: Clustering & Cell Types", emoji: "🧩", category: "cursor", priority: "P3", xp: 30, reward: "🧩 Cell type atlas complete. Pipeline paused for your validation.",
      desc: "CONCORD+Harmony clustering, cortical layer assignment, CPS proxy score.",
      steps: [
        { id: "c-p3-1", title: "Cursor packet: P3_clustering_and_cell_types.md", type: "code", desc: "Leiden clustering, cell type annotation, laminar assignment, subclustering.", checklist: ["Cell types annotated","Laminar assignment done","Subclusters: eN laminar, microglia states, astrocyte states","PIPELINE PAUSED — user validates annotations before advancing"], xp: 25, cognitive_type: "deep" },
        estimated_blocks: 6,
        { id: "c-p3-2", title: "USER VALIDATION CHECKPOINT", type: "validation", desc: "Inspect UMAP colored by marker gene expression. Inspect spatial plots with cell type overlays. Validate that FIC shows no L4 RORB+ band. Validate VENs appear only in FIC Layer Va. Sign off before advancing.", checklist: ["UMAP inspected","Spatial tissue plots inspected","FIC L4 absence confirmed","VEN spatial specificity confirmed","Written sign-off recorded in notebook"], xp: 5, cognitive_type: "deep" },
        estimated_blocks: 2,
      ],
    ...
    {
      id: "c-p4", title: "P4: Differential Expression", emoji: "📊", category: "cursor", priority: "P4", xp: 30, reward: "📊 Extended DEG framework run. Disease signatures characterized.",
    ...
    {
      id: "c-p5", title: "P5: Spatial Domains & LR", emoji: "🗺️", category: "cursor", priority: "P5", xp: 30, reward: "🗺️ Tissue map complete. Cell-cell communication characterized.",
    ...
    {
      id: "c-p6", title: "P6: Integration & Embedding", emoji: "🔮", category: "cursor", priority: "P6", xp: 25, reward: "🔮 Multi-sample integration locked. SAE features interpretable.",
    ...
    {
      id: "c-p7", title: "P7: Ghost Cells & DAPI", emoji: "👻", category: "cursor", priority: "P7", xp: 25, reward: "👻 Ghost cell biology characterized. DAPI texture pipeline working.",
  ...
  learning: [
    {
      ...
      steps: [
        { id: "l-sf-1", title: "Read full paper + methods", type: "learning", desc: "Read Eng et al. 2019 Science. Focus: encoding strategy, barcode design, error correction, FDR computation, decoding pipeline. Take notes on every step that generates a parameter you use.", checklist: ["Paper read with active notes","Encoding strategy understood","FDR computation understood","Notes: how does the decoder fail?"], xp: 5, cognitive_type: "medium" },
        estimated_blocks: 2,
        { id: "l-sf-2", title: "Implement a toy decoder (1 hyb round)", type: "code", desc: "Implement a simplified version of the seqFISH barcode matching for 1 hybridization round from scratch (Python). This forces deep understanding of the decoding logic.", checklist: ["Toy decoder implemented","Correct barcodes decoded from synthetic data","Error rate tested at different noise levels"], xp: 5, cognitive_type: "deep", compute_lead_hrs: 24 },
        estimated_blocks: 2,
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        estimated_blocks: 2,
        { id: "l-n-2", title: "Replication check: do their key findings appear in your data?", type: "code", desc: "Run a quick check of NuSPIRe's top reported spatial gene expression patterns. If they appear in your data: positive control. If not: investigate.", checklist: ["NuSPIRe top findings checked in your data","Discrepancies documented (platform vs. biology)"], xp: 3, cognitive_type: "deep" },
        estimated_blocks: 2,
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "l-ass-1", title: "Read Newman 2003 Physical Review Letters", type: "learning", desc: "THE assortativity paper. Understand the formula from first principles — not just how to use the function.", checklist: ["Paper read","Formula derived on paper","Intuition: what does r = 0.5 mean biologically?"], xp: 3, cognitive_type: "medium" },
        estimated_blocks: 2,
        { id: "l-ass-2", title: "Implement assortativity on spatial graph", type: "code", desc: "Compute assortativity on a simple test graph using the formula directly (not just networkx.degree_assortativity_coefficient). Verify matches NetworkX.", checklist: ["Formula implemented from scratch","Result matches NetworkX","Applied to 2 samples from your data: what is r?"], xp: 3, cognitive_type: "deep" },
        estimated_blocks: 2,
      ],
  ...
  career: [
    ...
    {
      id: "car-preprint", title: "First Preprint (bioRxiv)", emoji: "📬", category: "career", priority: "2026", xp: 40,
    ...
    {
      id: "car-defense", title: "PhD Defense", emoji: "🎓", category: "career", priority: "Nov 2026", xp: 80,
      desc: "PhD defense at Caltech Bioengineering. Target: November 2026.",
      reward: "🎓 DR. RAHMA. You did it.",
      steps: [
        { id: "car-d-1", title: "Thesis submitted to committee", type: "writing", desc: "Full thesis (3-4 chapters) submitted to committee. Minimum 2 weeks before defense.", checklist: ["All chapters approved by advisor","Formatting requirements met","Submitted to committee 2+ weeks before defense"], xp: 30, cognitive_type: "deep" },
        estimated_blocks: 6,
        { id: "car-d-2", title: "Defense presentation", type: "writing", desc: "45-minute presentation + Q&A. Practice with lab 2× before. Prepare for hardest questions from robustness_and_validation.md universal critiques.", checklist: ["2 practice talks done","Answers to top 10 reviewer critiques prepared","Slides reviewed by advisor"], xp: 30, cognitive_type: "deep" },
        estimated_blocks: 6,
        { id: "car-d-3", title: "Defense passed + revisions submitted", type: "writing", desc: "Defense passed. Committee revisions (if any) completed and submitted. Degree conferred.", checklist: ["Defense passed","All revisions completed","Degree conferred by Caltech Registrar"], xp: 20, cognitive_type: "deep" },
        estimated_blocks: 6,
      ],
    ...
    {
      id: "car-txomics-release", title: "txomics Public Release", emoji: "🚀", category: "career", priority: "2026", xp: 25,
      ...
      steps: [
        { id: "car-tx-1", title: "v1.0 release on PyPI", type: "code", desc: "Final documentation pass, tests at >80% coverage, version 1.0.0 released on PyPI.", checklist: ["All public functions documented","Test coverage > 80%","pip install txomics works from PyPI","CHANGELOG.md written"], xp: 15, cognitive_type: "deep" },
        estimated_blocks: 6,
        { id: "car-tx-2", title: "Announcement + usage in paper Methods", type: "writing", desc: "Announce on Twitter/X. GitPages site live with interactive demo. Cited in flagship paper Methods as 'analyses performed using txomics (github.com/rahma/txomics)'.", checklist: ["Announcement posted","GitPages site live","Cited in flagship paper Methods section"], xp: 10, cognitive_type: "deep" },
        estimated_blocks: 4,
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "car-o-1", title: "Offer received and negotiated", type: "career", desc: "Offer received. Negotiate: title, salary, lab independence, publication rights. Consult advisor and peers on offer terms.", checklist: ["Offer received","Salary benchmarked (Levels.fyi, ask postdocs/peers)","Negotiation attempt made","Offer signed"], xp: 50, cognitive_type: "deep" },
        estimated_blocks: 2,
        { id: "car-o-2", title: "Start date confirmed. YOU DID IT. 🎉", type: "career", desc: "Start date confirmed. Give yourself 2 weeks off. You spent 5+ years on this. Celebrate properly.", checklist: ["Start date confirmed","2 weeks off taken","Celebrate with people who matter"], xp: 50, cognitive_type: "deep" },
        estimated_blocks: 2,
      ],
